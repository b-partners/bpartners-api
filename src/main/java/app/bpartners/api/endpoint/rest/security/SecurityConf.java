...
public class SecurityConf extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http.exceptionHandling()
        ...
        .permitAll()
        .antMatchers("/onboardingInitiation")
        .permitAll()
        .antMatchers(POST, "/preUsers")
        .permitAll()
        // Authentication check done in controller for legalFiles
        .antMatchers(GET, "/users/*/legalFiles")
        .permitAll()
        .antMatchers(PUT, "/users/*/legalFiles/*")
        .permitAll()
        .antMatchers(OPTIONS, "/**")
        .permitAll()
        ...
        .antMatchers(POST, "/users/accounts/refresh").hasAnyRole(EVAL_PROSPECT.getRole())
        .requestMatchers(
        ...
        .authenticated()
        .antMatchers(GET, "/businessActivities")
        .authenticated()
        // TODO: set SelfUserAccountHolderMatcher
        .antMatchers(PUT, "/users/*/accounts/*/accountHolders/*/businessActivities")
        .authenticated()
        .antMatchers(PUT, "/users/*/accounts/*/accountHolders/*/revenueTargets")
        .authenticated()
        .antMatchers(PUT, "/users/*/accounts/*/accountHolders/*/companyInfo")
        .authenticated()
        .antMatchers(PUT, "/users/*/accounts/*/accountHolders/*/globalInfo")
        .authenticated()
        .antMatchers(PUT, "/users/*/accountHolders/*/feedback/*")
        .authenticated()
        .antMatchers(POST, "/users/*/accountHolders/*/feedback")
        .authenticated()
        .requestMatchers(
