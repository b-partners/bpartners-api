...
public class SecurityConf extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http
        ...
        .authenticated()
        .requestMatchers(
            new SelfAccountHolderMatcher(PUT, "/accountHolders/*/prospects/evaluationJobs", authResourceProvider))
        .authenticated()
        .requestMatchers(
        ...
        .requestMatchers(
            new SelfAccountHolderMatcher(POST, "/accountHolders/*/prospects/evaluations",
                authResourceProvider))
        .hasAnyRole(EVAL_PROSPECT.getRole())
        .requestMatchers(
