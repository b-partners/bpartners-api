        ...
        .authorizeHttpRequests(
            (authorize) ->
                authorize
                    ...
                    .permitAll()
                    // Authentication check done in user controller for the free trial
                    .requestMatchers(POST, "/users/*/subscriptionTrial")
                    .permitAll()
                    ...
                    .requestMatchers(
                        new SelfUserMatcher(
                            GET, "/users/*/subscriptionTrialEligibility", authResourceProvider))
                    .authenticated()
                    .requestMatchers(
                    ...
                    .requestMatchers(
                        new SelfUserMatcher(
                            POST, "/users/*/subscriptionCancel", authResourceProvider))
                    .authenticated()
                    .requestMatchers(
                        new SelfUserMatcher(
