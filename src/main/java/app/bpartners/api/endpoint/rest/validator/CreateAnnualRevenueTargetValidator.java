...
public class CreateAnnualRevenueTargetValidator implements Consumer<CreateAnnualRevenueTarget> {
  ...
  private void checkDuplicatedRevenues(List<CreateAnnualRevenueTarget> createAnnualRevenueTargets) {
    for (CreateAnnualRevenueTarget revenue : createAnnualRevenueTargets) {
      List<CreateAnnualRevenueTarget> target =
          createAnnualRevenueTargets.stream()
