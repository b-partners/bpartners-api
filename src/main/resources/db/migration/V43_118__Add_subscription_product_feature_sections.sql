alter table "subscription_product"
    add column if not exists feature_sections json;
  ...
  "Support 7j/7 par email"
    ...
    feature_sections = '[
      ...
      },
      {
        "title": null,
        "items": [
          {"text": "5 € HT / analyse supplémentaire", "style": "NORMAL"},
          {"text": "Marque blanche / co-branding du rapport", "style": "NORMAL"},
          {"text": "Bouton sur votre site pour génération de prospects", "style": "NORMAL"},
          {"text": "**Communauté BIRDIA** — 1 chantier proposé / mois (particulier, entretien)", "style": "NORMAL"},
          {"text": "Support 7j/7 par email", "style": "NORMAL"}
        ]
      }
    ]'
    ...
    feature_sections = '[
      {
        "title": null,
        "items": [
          {"text": "**Communauté BIRDIA** — +2 chantiers / mois (particuliers, entretiens)", "style": "NORMAL"},
          {"text": "**Outil d''aide aux appels d''offres** publics ou grands groupes", "style": "NORMAL"},
          {"text": "4 € HT / analyse supplémentaire", "style": "NORMAL"},
          {"text": "Module devis automatisé", "style": "NORMAL"},
          {"text": "Support prioritaire", "style": "NORMAL"}
        ]
      }
    ]'
...
update "subscription_product"
set features         = '[
  "Communauté BIRDIA — +5 chantiers / mois (particuliers, entretiens, AO)",
  "3 € HT / analyse supplémentaire",
  "Accès API & webhooks",
  "Monitoring annuel — re-scan automatique",
  "Multi-agences / multi-marques",
  "Support dédié 4 h ouvrées"
]',
    feature_sections = '[
      {
        "title": null,
        "items": [
          {"text": "**Communauté BIRDIA** — +5 chantiers / mois (particuliers, entretiens, AO)", "style": "NORMAL"},
          {"text": "3 € HT / analyse supplémentaire", "style": "NORMAL"},
          {"text": "Accès API & webhooks", "style": "NORMAL"},
          {"text": "Monitoring annuel — re-scan automatique", "style": "NORMAL"},
          {"text": "Multi-agences / multi-marques", "style": "NORMAL"},
          {"text": "Support dédié 4 h ouvrées", "style": "NORMAL"}
        ]
      }
    ]'
