...
values ('beed1765-5c16-472a-b3f4-5c376ce5db58', 'joe_doe_id', 'Account_name', 'FR0123456789',
       ...
       ('other_joe_account_id', 'joe_doe_id', 'Other joe account', 'Other iban',
        'Other bic', '0/1', 'OPENED', 'other_joe_external_account_id'),
       ...
       ('other_bernard_account_id', 'bernard_doe_id', 'Other bernard account', 'Other iban',
        'Other bic', '0/1', 'OPENED', 'other_bernard_account_id');