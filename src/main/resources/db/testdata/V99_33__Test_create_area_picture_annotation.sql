...
insert into "area_picture_annotation_instance" (id,humidity_level, slope, area, covering, wear_level, polygon, label_name, label_type,
                                                id_annotation, id_user, id_area_picture, obstacle, fill_color,
                                                stroke_color, comment, wearness, mold_rate)
values ('area_picture_annotation_instance_1_id', 10, 80, 90, 'Tuiles', 100, '{
  "points": [
    {
      "x": 1.0,
      "y": 1.0
       ...
       ('area_picture_annotation_instance_2_id', 10, 80, 90, 'Beton', 100, '{
         "points": [
           {
             "x": 2.0,
             "y": 2.0
       ...
       ('area_picture_annotation_instance_3_id', 10, 80, 90, 'Tuiles', 100, '{
         "points": [
           {
             "x": 1.0,
             "y": 1.0
