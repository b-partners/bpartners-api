...
class DirtyAccountHolderIT extends MockedThirdParties {
  ...
  void update_annual_revenue_target_ok() throws ApiException {
    ...
    AccountHolder actual =
        api.updateRevenueTargets(
            ...
            List.of(toUpdateAnnualRevenueTarget()));
  ...
  void update_company_info_ok() throws ApiException {
    ...
    AccountHolder actual =
        api.updateCompanyInfo(
            ...
            JOE_DOE_ACCOUNT_ID,
            joeDoeAccountHolder().getId(),
            companyInfo().location(location().latitude(43.5).longitude(2.5)).townCode(92002));
    ...
    assertEquals(
        expected()
            ...
            .revenueTargets(actual.getRevenueTargets()),
        actual);
  ...
  void update_business_activities_ok() throws ApiException {
    ...
    assertEquals(expected().companyInfo(expected().getCompanyInfo().isSubjectToVat(true)), actual);
  }
}
