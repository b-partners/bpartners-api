...
import app.bpartners.api.endpoint.rest.api.TeachingApi;
import app.bpartners.api.endpoint.rest.client.ApiClient;
import app.bpartners.api.endpoint.rest.client.ApiException;
import app.bpartners.api.endpoint.rest.model.Group;
...
public class GroupIT {
  ...
  void badtoken_read_ko() {
    ApiClient anonymousClient = anApiClient(TestUtils.BAD_TOKEN);

    TeachingApi api = new TeachingApi(anonymousClient);
    TestUtils.assertThrowsForbiddenException(api::getGroups);
  }
  ...
  void badtoken_write_ko() {
    ...
    TeachingApi api = new TeachingApi(anonymousClient);
    TestUtils.assertThrowsForbiddenException(() -> api.createOrUpdateGroups(List.of()));
  }
  ...
  void manager_write_create_ok() throws ApiException {
    ...
    Assertions.assertTrue(TestUtils.isValidUUID(created3.getId()));
    ...
    Assertions.assertTrue(TestUtils.isValidUUID(created4.getId()));
