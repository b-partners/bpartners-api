...
class InvoiceRelaunchIT {
  ...
  private static InvoiceRelaunch createdRelaunch() {
  ...
  void create_or_read_relaunch_ko() {
    ...
    assertThrowsForbiddenException(
        () -> api.getInvoiceRelaunch("not" + JOE_DOE_ACCOUNT_ID)
    );
    assertThrowsForbiddenException(
        () -> api.configureRelaunch("not" + JOE_DOE_ACCOUNT_ID, createInvoiceRelaunch())
    );
  }
  ...
  void create_invoice_relaunch_ok() throws ApiException {
    ApiClient joeDoeClient = anApiClient();
    PayingApi api = new PayingApi(joeDoeClient);
    InvoiceRelaunch expected = createdRelaunch();

    InvoiceRelaunch actual = api.configureRelaunch(JOE_DOE_ACCOUNT_ID, createInvoiceRelaunch());
