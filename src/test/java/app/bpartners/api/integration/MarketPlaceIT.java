...
class MarketPlaceIT extends MockedThirdParties {
  ...
  Marketplace defaultMarketPlace1() {
    return new Marketplace()
        ...
        .logoUrl("https://public-logo-resources.s3.eu-west-3.amazonaws.com/place-logo.png");
  }
  ...
  void read_marketplaces_ok() throws ApiException {
    ...
    List<Marketplace> actual = ignoreDescription(api.getMarketplaces(JOE_DOE_ACCOUNT_ID, 1, 20));
    assertTrue(
        actual.containsAll(
            List.of(marketPlace1(), marketPlace2(), defaultMarketPlace1(), defaultMarketPlace2())));
  }
