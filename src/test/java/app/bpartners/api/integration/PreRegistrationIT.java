...
public class PreRegistrationIT {
  ...
  PreRegistration preRegistration1() {
    ...
    preRegistration.setEmail(TestUtils.VALID_EMAIL);
    preRegistration.setFirstName("john");
    preRegistration.setLastName("doe");
    preRegistration.setSociety("johnSociety");
    preRegistration.setPhoneNumber("+33 54 234 234");
