...
class AccountRepositoryTest {
    ...
    @InjectMocks
    private AccountRepositoryImpl accountRepositoryImpl; // Suppose que c'est l'implémentation de AccountRepository
    ...
    void findByBearer_returnsAccountList() {
        when(accountRepository.findByBearer("someBearerToken"))
