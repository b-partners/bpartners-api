...
class UserTokenRepositoryImplTest {
  Instant BRIDGE_ITEM_UPDATED_AT = Instant.parse("2023-03-30T13:35:26.853Z");
  Instant BRIDGE_ITEM_LAST_REFRESH = Instant.parse("2023-04-30T13:35:26.853Z");
  ...
  User user() {
    return User.builder()
        ...
        .bankConnectionId(1L)
        .bridgeItemUpdatedAt(BRIDGE_ITEM_UPDATED_AT)
        .bridgeItemLastRefresh(BRIDGE_ITEM_LAST_REFRESH)
        .accessToken(JOE_DOE_TOKEN)
