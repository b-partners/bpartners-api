...
public class SubscriptionServiceTest {
    ...
    SubscriptionProductRepository subscriptionProductRepositoryMock = mock(SubscriptionProductRepository.class);
    SubscriptionService subject = new SubscriptionService(stripeConfMock, stripeClientMock, userRepositoryMock, subscriptionProductRepositoryMock);

    @Test
    void get_by_subscription_type_ok() throws StripeException {
        var userSubscriptionType = UserSubscriptionType.ESSENTIAL;
        when(stripeConfMock.getEssentialSubscriptionProductId()).thenReturn("esentialSubscriptionProductId");
        when(subscriptionProductRepositoryMock.findById(any())).thenReturn(Optional.ofNullable(mock(SubscriptionProduct.class)));
        ...
        var subscriptionProduct = SubscriptionProduct.builder()
