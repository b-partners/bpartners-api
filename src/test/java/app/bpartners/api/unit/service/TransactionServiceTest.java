...
class TransactionServiceTest {
    ...
    CustomDateFormatter customDateFormatterMock = mock();
     TransactionService subject = new TransactionService(
    ...
    void get_supporting_documents() {
         ...
         var transaction = Transaction.builder().supportingDocuments(List.of(supportingDocuments)).build();
    ...
    void add_supporting_document() throws IOException {
         ...
         var transaction = Transaction.builder().supportingDocuments(List.of(transactionSupportingDocs)).build();
         when(dbTransactionRepositoryMock.findById(any())).thenReturn(transaction);
    ...
    void generate_transaction_summary_link() throws IOException {
         ...
         var transaction = Transaction.builder()
                 ...
                 .build();
         when(dbTransactionRepositoryMock
                 .findByAccountIdAndStatusBetweenInstants(anyString(), any(), any(), any()))
