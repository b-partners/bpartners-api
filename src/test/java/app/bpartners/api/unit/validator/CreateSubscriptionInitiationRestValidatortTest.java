...
public class CreateSubscriptionInitiationRestValidatortTest {
    CreateSubscriptionInitiationRestValidator subject = new CreateSubscriptionInitiationRestValidator();
    ...
    void accept_with_exceptionMsg() {
        var actual = assertThrows(IllegalArgumentException.class, () -> subject.accept(new CreateSubscriptionInitiation()));

        assertEquals("subscriptionType can not be null. redirectionStatusUrls can not be null. ", actual.getMessage());
    }
